...
-- El campo user_id de la tabla "dni" es clave foránea, mientras que es la clave primaria de la tabla "users"
...
-- El campo user_id y language_id de la tabla intermedia "users_languages" es clave foránea de las claves primarias user_id de la tabla "users" y de language_id de la tabla "languages"
